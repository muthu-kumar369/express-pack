...
// // code for setup
// import config from "../config/fileContent.js";
...
// import packageJson from projectPackageJsonPath;
...
//     fs.writeFileSync(path.join(projectDir, "index.js"), config.indexJsContent);

//     fs.writeFileSync(
//       path.join(configDir, "appConfig.js"),
//       config.appConfigJsContent
//     );

//     fs.writeFileSync(
//       path.join(configDir, "routeConfig.js"),
//       config.routeConfigJsContent
//     );
